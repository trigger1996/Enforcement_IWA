...
def main():
    ...
    t_aic_case_3 = t_aic('src/opacity_iwa/iwa_TS/team_3_robots.yaml', ['(1,3,4)'], event_c, event_o, event_uc, event_uo)
    ...
    map_iwa.load_map_control_from_yaml('src/opacity_iwa/iwa_TS/map.yaml')

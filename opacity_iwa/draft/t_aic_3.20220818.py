...
class t_bts():
    ...
    def construct_T_BTS(self, source=None, event_uo=None, event_o=None, event_c=None, event_uc=None):
        ...
        while y_stack:
            ...
            for state_2_nx in self.t_bts.node:
                ...
                y_state_nx = self.observable_reach(state_2_nx, current_state)
    ...
    def dfstree(self, iwa, event_list, event_uc, event_uo, source):
        ...
        for edge_t in edges:
            ...
            try:
                ...
                if (event in event_list and event not in event_uo):
    ...
    def observable_reach(self, z_state, current_y_state):
        ...
        '''
        data structure:
            [ (state_1, (event_1, (t_1, t_2))),
              (state_2, (event_2, (t_3, t_4))), 
              ...
             ]
        '''
        nx_star = []
            ...
            for edge_t in reachable_edge_nx:
                ...
                if event_t in self.event_o and \
                   (event_t in self.event_uc or \
                    ...
                    nx_star.append((edge_end, (event_t, (event_t_min, event_t_max))))
